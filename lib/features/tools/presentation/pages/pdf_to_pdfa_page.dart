...
class PdfToPdfaPage extends StatefulWidget {
  const PdfToPdfaPage({super.key});
  @override
  State<PdfToPdfaPage> createState() => _PdfToPdfaPageState();
}

class _PdfToPdfaPageState extends State<PdfToPdfaPage> {
  String? _filePath;
        ...
        child: Column(
          ...
          children: [
            ...
            ProcessButton(
              ...
              onPressed: _filePath != null ? () async => await provider.processTool(AppStrings.pdfToPdfa, _filePath) : null,
            ),
