...
class PdfToPptPage extends StatefulWidget {
  const PdfToPptPage({super.key});
  @override
  State<PdfToPptPage> createState() => _PdfToPptPageState();
}

class _PdfToPptPageState extends State<PdfToPptPage> {
  String? _filePath;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ProcessButton(
              label: 'Konversi ke PPTX',
              icon: Icons.present_to_all_rounded,
              isLoading: provider.isProcessing,
              onPressed: _filePath != null ? () async => await provider.processTool(AppStrings.pdfToPpt, _filePath) : null,
            ),
