...
class ComparePdfPage extends StatefulWidget {
  const ComparePdfPage({super.key});
  @override
  State<ComparePdfPage> createState() => _ComparePdfPageState();
}

class _ComparePdfPageState extends State<ComparePdfPage> {
  String? _filePath;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ProcessButton(
              label: 'Bandingkan PDF',
              icon: Icons.compare_rounded,
              isLoading: provider.isProcessing,
              onPressed: _filePath != null ? () async => await provider.processTool(AppStrings.comparePdf, _filePath) : null,
            ),
