...
class TranslatePdfPage extends StatefulWidget {
  const TranslatePdfPage({super.key});
  @override
  State<TranslatePdfPage> createState() => _TranslatePdfPageState();
}

class _TranslatePdfPageState extends State<TranslatePdfPage> {
  String? _filePath;
        ...
        child: Column(
          ...
          children: [
            ...
            ProcessButton(
              ...
              onPressed: _filePath != null ? () async => await provider.processTool(AppStrings.translatePdf, _filePath) : null,
            ),
